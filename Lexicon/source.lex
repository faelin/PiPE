...
## PRE-BUILT PHRASES:
    * IMPORT [package] <period>             // global package invocation
      USE [package] <period>                // global package invocation
    * <lparen> USING [package] <rparen>     // local  package invocation

    * LETS TALK ABOUT [noun] <period>       // package declaration

    * IN [language] <colon>                 // native language declaration
